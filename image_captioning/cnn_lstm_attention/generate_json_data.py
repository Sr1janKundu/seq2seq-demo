...
if __name__ == "__main__":
    ...
    parser.add_argument('--min-word-count', type=int, default=5,
                        help='minimum number of occurrences of a word to be included in word dictionary')
